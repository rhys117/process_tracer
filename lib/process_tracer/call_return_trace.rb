module ProcessTracer
  ##
  # Do not use. Check LineTrace instead.
  class CallReturnTrace
    ...
    def initialize(force_allow: false, &blk)
      unless force_allow
        raise 'Deprecated for LineTrace. Temporarily keeping for reference'
      end
